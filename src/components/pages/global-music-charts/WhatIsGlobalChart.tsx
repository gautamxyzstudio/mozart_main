        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 md:gap-[18px] xl:gap-24 w-full mt-10 md:mt-16">
          ...
          <div className="w-full md:w-1/2 flex flex-col items-center md:items-start text-center md:text-left">
            <h2 className="text-4xl md:text-[40px] xl:text-[56px] font-bold text-white leading-[1.15] mb-6">
              What Are Global Music Charts <br className="hidden md:block" />
              and Why Do They Matter?
            </h2>
            
            <p className="text-[#a1a1aa] text-sm md:text-base xl:text-lg mb-10 font-light leading-[1.8] max-w-[540px]">
              Global music charts are real time rankings that measure how well a song is performing across platforms like Spotify, Apple Music, and YouTube Music — based on streams, downloads, and listener activity. For independent artists, tracking your worldwide music chart position shows you exactly which markets are growing, which audiences are responding, and where your next opportunity is. Without chart data, you release music blindly. With it, every decision becomes smarter.
            </p>
