  ...
  return (
    <>
      <section className="bg-white xl:-mt-8 md:-mt-5 -mt-3">
        <span className="w-full xl:text-[200px] xl:leading-51.5 md:text-[120px] md:leading-32.5 text-[60px] leading-19 text-black/70 font-bold opacity-10   xl:-ml-3 md:-ml-1 -ml-1">
          Features
        </span>
