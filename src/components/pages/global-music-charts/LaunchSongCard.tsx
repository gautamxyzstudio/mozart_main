    ...
    <div className="w-full  bg-slate-100 flex items-center justify-center xl:py-34 xl:px-23.25 md:py-20 md:px-10 py-10 px-6">
      ...
      <div className="relative w-full  bg-primary rounded-4xl p-8 md:p-14 flex flex-col md:flex-row md:items-center md:justify-between overflow-hidden shadow-xl">
        ...
        <div className="w-full md:w-[55%] flex flex-col items-center md:items-start text-center md:text-left z-10">
          <h2 className="text-white text-[28px] xl:text-[60px]  md:text-[30px] font-bold  xl:leading-18 md:leading-10 mb-4 xl:mt-26 md:mt-10">
            Start Tracking Your Music on Global Charts Today
          </h2>

          <p className="text-white/90 text-sm md:text-base xl:text-lg mb-8 md:mb-10 font-light max-w-xl">
            Real data. Worldwide rankings. Smarter releases. Join independent artists already growing with Amozart.
          </p>
        ...
        <div className="w-full md:w-[45%] flex justify-center items-center mt-10 md:mt-0 z-10">
