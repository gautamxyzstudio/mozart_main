      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 md:px-13 xl:px-28 pt-28 pb-16 md:pt-36 md:pb-24 lg:pt-44 lg:pb-32">
        ...
        <div className="max-w-[1000px] text-black80 font-medium text-base md:text-lg leading-7 md:leading-8 space-y-5">
          ...
          <div className="space-y-4">
            ...
            <p className="text-base text-[#414141] font-normal">
              10.7 Law and Jurisdiction: This Agreement shall be governed and construed in accordance with the laws of Canada. When valid by law, any dispute, controversy or claim arising under, out of or relating to this contract and any subsequent amendments of this contract, including, without limitation, its formation, validity, binding effect, interpretation, performance, breach or termination, as well as non-contractual claims, shall be referred to and finally determined by arbitration in accordance with the WIPO Arbitration Rules. The arbitral tribunal shall consist of a sole arbitrator. The place of arbitration shall be Surrey (Canada). The language to be used in the arbitral proceedings shall be English. However, if local regulations establish any kind of limitation based on the nature of the End User, any claims or lawsuits between the parties will be resolved by the Courts of the city of Surrey (Canada).
            </p>
          </div>
        </div>
      </div>
